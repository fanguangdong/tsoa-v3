...
<script type="text/javascript">
	var zNodes =[
		...
		{ id:102, parentId:3001, name:"表单模板管理",url:"formTemplate_list.action", target:"frmright",iconOpen:"libs/icons/folder_doc.gif",iconClose:"libs/icons/folder_doc.gif",icon:"system/layout/skin/titlebar_arrow.gif"},
		...
		{ id:302, parentId:3009, name:"岗位管理",url:"formTemplate_list.action", target:"frmright",iconOpen:"libs/icons/folder_doc.gif",iconClose:"libs/icons/folder_doc.gif",icon:"system/layout/skin/titlebar_arrow.gif"},
		...
		{ id:304, parentId:3009, name:"待我审批",url:"form_myTaskList.action", target:"frmright",iconOpen:"libs/icons/folder_doc.gif",iconClose:"libs/icons/folder_doc.gif",icon:"system/layout/skin/titlebar_arrow.gif"},
		{ id:305, parentId:3009, name:"我的申请查询",url:"form_myApplicationList.action", target:"frmright",iconOpen:"libs/icons/folder_doc.gif",iconClose:"libs/icons/folder_doc.gif",icon:"system/layout/skin/titlebar_arrow.gif"},
